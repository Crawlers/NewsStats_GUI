...
PieChartView.prototype.sendFiteredData = function(req,res){
	...
	var collection = req.db.get(obj.metadata.collection);
	    collection.col.aggregate([
		  {$match: req.body},
		  {$group: { _id: {field1: $field1, field2: $field2}, count1: {$sum: $frq}}},
		  {$group: { 
		      _id: "$_id.field2",
			  crime_years: {
				  $push: {
...
metadata.params = {title: 'Crime Hot Spots', filter_title1: 'Crime Type', filter_title2: 'Year'};
...
var metadata = {collection: 'crimes'};
metadata.params = {title: 'Crime Type Comparisons', xtitle1: 'Year', xtitle2: 'Crime Type'};
...
metadata.field = {frequency: 'crime_count', field1: 'crime_year', field2: 'crime_type'};
metadata.alias = {frequency: 'Crime Count', field1: 'Year', field2: 'Crime Type'};
metadata.params = {title1: 'Crime Type Comparisons', title2: 'Crime Type Distribution of Sri Lanka for Each Year'}
var crimePieChartView = new PieChartView(metadata);

var metadata = {collection: 'crimes'};
metadata.params = {title: 'Crime Frequency Variations over Time'};
...
metadata.params = {title: 'Predicted Crime Hot Spots', filter_title1: 'Crime Type', filter_title2: 'Year'};
metadata.field = {location: 'crime_district', frequency: 'crime_count', field1: 'crime_type', field2: 'crime_year'};
metadata.alias = {location: 'District', frequency: 'Crime Frequency', field1: 'Crime Type', field2: 'Year'};
var predictionMapView = new MapView(metadata);

var metadata = {collection: 'predictions'};
metadata.params = {title: 'Predicted Crime Distribution of Sri Lanka for 2014,2015', xtitle1: 'Year', xtitle2: 'Crime Type'};
metadata.field = {frequency: 'crime_count', field1: 'crime_year', field2: 'crime_type'};
metadata.alias = {frequency: 'Crime Count', field1: 'Year', field2: 'Crime Type'};
...
metadata.field = {frequency: 'crime_count', field1: 'crime_year', field2: 'crime_type'};
metadata.alias = {frequency: 'Crime Count', field1: 'Year', field2: 'Crime Type'};
metadata.params = {title1: 'Predicted Crime Type Comparisons', title2: 'Predicted Crime Type Distribution of Sri Lanka for Each Quarter in 2014'};
var predictionPieChartView = new PieChartView(metadata);

var metadata = {collection: 'predictions_type'};
metadata.params = {title: 'Predicted Crime Frequency Variations over Time'};
metadata.field = {frequency: 'crime_count', field1: 'crime_yearquarter', field2: 'crime_type'};
