...
metadata.alias = {frequency: 'Crime Frequency', field1: 'Quarter of the year', field2: 'Crime Type'};
...
metadata.alias = {location: 'District', frequency: 'Crime Frequency', field1: 'Crime Type', field2: 'Quarter of the year'};
